...
class CarControllerParams():
  ...
  STEER_STEP = 4 # 4 control frames per command
  ...
  def __init__(self, CP):
    self.STEER_MAX = 300  # 384 good, 409 is the max, 255 is stock, Original was 300
    self.STEER_DELTA_UP = 8 #10
    self.STEER_DELTA_DOWN = 12 #15
